...
def MLR(training_data,test_data,K_FOLD_SIZE,check):
    SSR_list = []
    SSE_list = []
    SST_list = []
    # ro=0
    ...
    print("For Training Data")
    k = ANOVA_CALC(SSE_list1, SST_list1, SSR_list1, R_sqaured_list1, MSE_list1,R1, MSR_list1, F_list1,
                   Adjusted_R_squared_list1, K_FOLD_SIZE)

    print("For Test Data")
    k_test = ANOVA_CALC(SSE_list, SST_list, SSR_list, R_sqaured_list, MSE_list,R2, MSR_list, F_list,
                        Adjusted_R_squared_list, K_FOLD_SIZE)
    return LSE_list, column, k, k_test,R_sqaured_list,Adjusted_R_squared_list,d,res_list_test,res_list_train,predicted_test,predicted_train,y_actual_test,y_actual_train,MSE_list
